...
1. `legal/PRIVACY_POLICY.md` — черновик с плейсхолдерами, нужен реальный публичный URL для Play
   Console (сам захостить не могу, нужно сначала заполнить юрлицо/адрес/контакт).
